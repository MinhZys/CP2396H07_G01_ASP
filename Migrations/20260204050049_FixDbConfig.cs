    ...
    public partial class FixDbConfig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2026, 2, 4, 12, 0, 48, 569, DateTimeKind.Local).AddTicks(103), "Standard classrooms", true, "Theory" },
                    { "2", new DateTime(2026, 2, 4, 12, 0, 48, 569, DateTimeKind.Local).AddTicks(115), "Computer labs", true, "Lab" },
                    { "3", new DateTime(2026, 2, 4, 12, 0, 48, 569, DateTimeKind.Local).AddTicks(116), "Virtual classes", true, "Online" }
                });
