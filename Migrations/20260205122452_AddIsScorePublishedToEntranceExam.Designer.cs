...
namespace CP2396H07_G01.Migrations
{
    ...
    [Migration("20260205122452_AddIsScorePublishedToEntranceExam")]
    partial class AddIsScorePublishedToEntranceExam
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Symphony.Portal.Web.Models.ClassCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            CreatedAt = new DateTime(2026, 2, 5, 19, 24, 51, 910, DateTimeKind.Local).AddTicks(8582),
                        ...
                        {
                            Id = "2",
                            CreatedAt = new DateTime(2026, 2, 5, 19, 24, 51, 910, DateTimeKind.Local).AddTicks(8600),
                        ...
                        {
                            Id = "3",
                            CreatedAt = new DateTime(2026, 2, 5, 19, 24, 51, 910, DateTimeKind.Local).AddTicks(8601),
            ...
            modelBuilder.Entity("Symphony.Portal.Web.Models.ClassExam", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("Symphony.Portal.Web.Models.ExamAttempt", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("Symphony.Portal.Web.Models.StudentCertificate", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("Symphony.Portal.Web.Models.Payment", b =>
                {
                    b.HasOne("Symphony.Portal.Web.Models.ExamAttempt", "ExamAttempt")
                        .WithMany()
            ...
            modelBuilder.Entity("Symphony.Portal.Web.Models.StudentExamSession", b =>
                {
                    b.HasOne("Symphony.Portal.Web.Models.ClassExam", "ClassExam")
                        .WithMany()
