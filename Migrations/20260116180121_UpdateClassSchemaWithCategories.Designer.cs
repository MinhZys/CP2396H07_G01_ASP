...
namespace CP2396H07_G01.Migrations
{
    ...
    [Migration("20260116180121_UpdateClassSchemaWithCategories")]
    partial class UpdateClassSchemaWithCategories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Symphony.Portal.Web.Models.Classroom", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("Symphony.Portal.Web.Models.Class", b =>
                {
                    ...
                    b.HasOne("Symphony.Portal.Web.Models.Classroom", "Classroom")
                        .WithMany()
